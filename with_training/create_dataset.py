...
def main():
    ...
    data_dir = Path("/home/Rudin/hpc_disk/Open_Images_Dataset_V5")  #path to your training data
    img_dir = data_dir.joinpath(f"{mode}_img") #path to your image data (train & test)
    mask_dir = data_dir.joinpath(f"{mode}_mask_img") #path to your mask image data (train & test)
    mask_csv_path = data_dir.joinpath(f"./meta_data/challenge-2019-{mode}-segmentation-masks.csv") #path to your meta data
